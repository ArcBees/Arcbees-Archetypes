...
public class HomePageView extends ViewWithUiHandlers<HomeUiHandlers> implements HomePagePresenter.MyView {
    ...
    @Inject
    public HomePageView(final Binder uiBinder, final UiHandlersStrategy<HomeUiHandlers> uiHandlers) {
        super(uiHandlers);
    ...
    void onSubmitClicked(ClickEvent event) {
        getUiHandlers().processUser(firstName.getText(), lastName.getText());
    }
}
